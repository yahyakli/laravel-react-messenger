...
export const AttachmentPerviewModal = ({
    attachments,
    index,
    show = false,
    onClose = () => {}
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="relative group h-full">
                                    {currentIndex > 0 && (
                                        <div onClick={prev} className="absolute opacity-100 text-gray-100 cursor-pointer flex items-center justify-center h-16 w-16 left-4 top-1/2 -translate-y-1/2 rounded-full bg-black/50 z-30" >
