...
import TextArealInput from "./TextArealInput";
        ...
        <Modal show={show} onClose={closeModal}>
            ...
            >
                ...
                <div className="mt-4">
                    ...
                    <TextArealInput id="description" rows="3" className="mt-1 block w-full" value={data.description || ""} onChange={(e) => setData("description", e.target.value)}/>
