        ...
        <section className={className}>
            ...
            <form onSubmit={submit} className="mt-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="file" id="avatar" className="file-input file-input-bordered rounded-lg file-input-primary w-full max-w-xs" onChange={(e) => setData("avatar", e.target.files[0])} />
